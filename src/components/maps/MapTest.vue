...
export default Vue.extend({
  ...
  methods: {
    ...
    splitLat(path){
      ...
      // });
      arr.push([[path[0].lng,path[0].lat],[centerLng,path[0].lat],[centerLng,centerLat],[path[0].lng,centerLat]])
      arr.push([[centerLng,path[1].lat],[path[1].lng,path[1].lat],[path[1].lng,centerLat,],[centerLng,centerLat]])
      arr.push([[centerLng,centerLat],[path[2].lng,centerLat],[path[2].lng,path[2].lat],[centerLng,path[2].lat]])
      arr.push([[path[3].lng,centerLat],[centerLng,centerLat],[centerLng,path[3].lat],[path[3].lng,path[3].lat]])
